...
#SBATCH --output=/gpfs/work5/0/prjs1828/DSI-QG/logs/test_bm25_100k.log
...
/gpfs/work5/0/prjs1828/DSI-QG/.venv/bin/python3 -m CE.utils.test.evaluation_BM25 --table_name "N100k_thread" --thread --size "100k" --version "v1.1"
