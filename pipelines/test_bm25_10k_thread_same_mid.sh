...
#SBATCH --output=/gpfs/work5/0/prjs1828/DSI-QG/logs/test_bm25_10k_thread_same_mid.log
...
/gpfs/work5/0/prjs1828/DSI-QG/.venv/bin/python3 -m CE.utils.test.evaluation_BM25 "N10k_thread_same_mid"
